...
include "navBar.php";
 ?>
    ...
    <div class="col-lg-4 mt-5">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title text-center">Le patient connecté</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table text-center">
                            ...
                            $ids=$_SESSION['id'];
                                    ...
                                    $recuperUser= $bdd->prepare("SELECT * FROM patient where id='$ids'");
            ...
            <div class="col-lg-7 text-center mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title text-center"> <?php echo $_SESSION['id']; ?> Choisissez un psychologue</h4>
                        <div class="single-table">
                            <div class="table-responsive">
                                <table class="table text-center">
                                    <thead class="text-uppercase bg-primary">
                            ...
                            ?>
                             ...
                             <tbody>
                                        <tr>
                                            ...
                                            <td><a href="chat.php?id=<?php echo $user['idpsc']; ?>   "><img src="image/message.png" style="width: 30px; height: 30px;"></a></td></a>
                                        </tr>
                                         </tbody>
