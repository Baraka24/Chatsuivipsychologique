...
if (isset($_POST['envoyer'])) {
    ...
    $motdepasse= htmlspecialchars($_POST['motdepasse']);
     ...
     $inserMenbre = $bdd->prepare("INSERT INTO patient(nom,  prenom, genre,motdepasse ) VALUES (?, ?, ?, ?)");
                ...
                <form method="post">
                    ...
                    <div class="login-form-body">
                        <div class="form-gp">
                            ...
                            <input type="text" id="exampleInputEmail1" name="nom" required>
                        ...
                        <div class="form-gp">
                            ...
                            <input type="text" id="exampleInputEmail1" name="prenom" required>
                        ...
                        <div class="form-gp">
                            ...
                            <input type="password" id="exampleInputPassword1" name="motdepasse" required>
